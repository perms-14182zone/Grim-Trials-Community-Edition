...
# 🎮 Grim Trials — Community Edition

**Grim Trials standalone Community Edition, ready to play.**
...
Grim Trials is a dark fantasy action roguelite in which players fight through escalating trial arenas, upgrade their arsenal, and face punishing multi-phase bosses. This Community Edition is a standalone, self-contained package of the complete game. The offline version requires no storefront and no additional software, and is ready to play immediately after installation.

For players who want a complete, self-contained offline version of Grim Trials that runs on Windows without a storefront.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2621930/da4c022fa83226386fc143bcf708a19bfca51729/ss_da4c022fa83226386fc143bcf708a19bfca51729.1920x1080.jpg?t=1787804428" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2621930/7c98b83e51e0dc754041d89482ea7403b32450de/ss_7c98b83e51e0dc754041d89482ea7403b32450de.1920x1080.jpg?t=1787804428" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2621930/173003ffcf1b7119b8a9da6eb1709da819adda47/ss_173003ffcf1b7119b8a9da6eb1709da819adda47.1920x1080.jpg?t=1787804428" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ⚔️ **Roguelite Progression** — Challenging trial runs with persistent meta-progression between sessions.
- 💀 **Dark Fantasy Setting** — Gothic arenas and a grim reaper-inspired world rendered in a distinct art style.
- 🗡️ **Weapon Variety** — Multiple weapon archetypes, each with unique move sets and upgrade paths.
- 👹 **Boss Encounters** — Multi-phase bosses guarding the end of every trial chain.
- 🌱 **Meta-Upgrades** — Permanent upgrades enabled with in-game currency across runs.
- 📦 **Self-Contained Package** — All game files included; no additional software required.
- 🖥️ **Offline Version** — Runs fully offline with no storefront or account needed.
- ⚡ **Ready to Play** — Includes all content from the base game; launch directly after installation.
...
| **Processor** | Intel Core i5-4460 / AMD FX-6300 | Intel Core i5-9400 / AMD Ryzen 5 2600 |
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 1050 (2 GB) / AMD Radeon RX 560 | NVIDIA GeForce GTX 1660 / AMD Radeon RX 5600 XT |
| **Storage** | 12 GB available space | 12 GB available space (SSD recommended) |
| **Additional** | DirectX 11 compatible system | DirectX 12 compatible system with SSD storage |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\GrimTrials\Saved`
